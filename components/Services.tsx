    ...
    <div className="services w-full h-full pt-[100px] mx-auto">
      <div className=" w-full px-[30px] md:px-[40px] flex flex-col items-center justify-center gap-2 lg:flex-row mx-auto ">
        <div className="basis-[50%] flex flex-col justify-center items-center w-full  h-full p-6 mx-auto">
          <div
            className={`w-[100%] max-w-[800px] h-[550px] max-h-[750px] sm:h-[670px] flex flex-col justify-center items-center p-6 bg-[url('/images/light/globe-light.svg')] bg-contain bg-center bg-no-repeat dark:bg-[url('/images/dark/globe-dark.svg')]  relative`}
          >
           <pre className="text-[18vw] md:text-[130px] font-semibold font-montreal  scale-y-[1.6] relative text-[var(--light)] dark:text-[var(--dark)]">W   RK</pre>
           {
            changeTheme?(
              <Image src={face} alt="" className="w-[25vw] h-[34vw] md:w-[190px] md:h-[240px] absolute mr-7 md:-mt-[67px] -mt-7"/>
            ):(
              <Image src={face_light} alt="" className="w-[25vw] h-[32vw] md:w-[190px] md:h-[225px] absolute mr-6 md:-mt-20 -mt-7"/>
            )
           }
           
           
            <p className=" relative  text-[10vw] md:text-[80px] font-semibold font-montreal mr-[36px]  text-[var(--light)] dark:text-[var(--dark)] scale-y-[1.6] mt-2">WITH ME</p> 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2  gap-3">
            {skillsItems.map((skill, i) => {
              return (
                <div
                  key={i}
                  className="group mx-auto w-[90%] h-[140px] sm:max-w-[360px] xl:w-[290px] sm:h-[180px] lg:h-[240px] xl:h-[185px] flex flex-col justify-center items-start border dark:border-gray-800 shadow-lg p-3 leading-tight xl:p-6
